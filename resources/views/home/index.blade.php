...
@php
    ...
    $transformations = \App\Models\Transformation::latest()->take(6)->get();

    $testimonials = \App\Models\Testimonial::latest()->take(6)->get();

$homepageCards = \App\Models\HomepageCard::where('is_active', true)
    ->orderBy('sort_order')
    ->get();
...
<section class="relative bg-[#f8f6f1] overflow-hidden">
    ...
    {!! nl2br($setting->hero_title ?? 'Transform Your Body, Transform Your Life') !!}
    ...
    {{ $setting->hero_subtitle ?? 'Expert fitness coaching and personalized nutrition plans.' }}
   ...
   class="bg-yellow-500 hover:bg-yellow-400 text-black font-bold px-8 py-4 rounded-2xl transition duration-300 shadow-lg hover:scale-105">
    ...
    {{ $setting->cta_button_text ?? 'Start Your Journey' }}
            ...
            <div class="relative flex justify-center">
                ...
                <img
                    src="{{ $setting && $setting->hero_image ? asset('storage/' . $setting->hero_image) : asset('images/dk-hero.jpeg') }}"
